        ...
        <div class="row">
          <div class="col-lg-6 col-md-6">
            <div class="hero-daycare-banner-text">
              <h1>Empowering <span class="blue-daycarev2">Daycare Centers</span> with Intelligent, Round-the-Clock Assistance</h1>
              <p>Leveraging AI to streamline communication and operations, letting you focus on what truly matters— the
                children</p>
         ...
         <div className='col-md-1'></div>
          <div class="col-lg-5 col-md-5">
              <div class="position-relative">
                ...
                <img src="/images/daycare/imag01.png" alt class="chatimgfit"/>
              </div>
    ...
    <section class="kwikbot-section2">
      <div class="container">
        ...
        <div class="row justify-content-center fade-section reverse-mobile">
          <div class="col-lg-5">
            <div class="generate-quality-leads-content px-3">
              ...
              <p>Daycare centers are bustling hubs of activity that juggle diverse responsibilities, from managing
                inquiries and communicating with parents, to booking appointments and ensuring top-notch child care.
                Handling all these tasks efficiently while delivering exceptional service can be a formidable challenge.
              </p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="generate-quality-leads-image ">
              <img src="images/daycare/daycarev2card01.png" alt="" width="100%"/>
            </div>
          </div>
        </div>
        <div class="row justify-content-center mt-100">
          <div class="col-lg-4 col-md-6">
            <div class="generate-quality-leads-image">
              <img src="images/daycare/daycarev2card02.png" alt="" width="100%"/>
            </div>
          </div>
          <div class="col-lg-1">
          ...
          <div class="col-lg-5">
            <div class="generate-quality-leads-content px-3">
              ...
              <p>Our AI chatbot, designed with cutting-edge generative models, steps in to shoulder these
                responsibilities. Available 24/7, fluent in multiple languages, and capable of intelligently
                interpreting and responding to queries, our chatbot helps streamline your operations, facilitate timely
                communication, and manage appointments effortlessly.</p>
            </div>
          </div>
        ...
        <div class="row justify-content-center mt-100 fade-section reverse-mobile">
            ...
            <div class="generate-quality-leads-content px-3">
              ...
              <ul>
                <li><img src="images/daycare/daycarev2-icon.png" alt=""/>
                  <p>Increased Leads: Our chatbot can handle multiple inquiries simultaneously, ensuring no potential
                    client goes unanswered.</p>
                </li>
                <li><img src="images/daycare/daycarev2-icon.png" alt=""/>
                  <p>Operational Efficiency: Automate repetitive tasks like answering FAQs and scheduling appointments,
                    freeing up your staff's time for more value-added activities.</p>
                </li>
                <li>
                  <img src="images/daycare/daycarev2-icon.png" alt=""/>
                  <p> Improved Parent Communication: Ensure parents receive prompt, accurate responses to their queries
          ...
          <div class="col-lg-4 col-md-6">
            <div class="generate-quality-leads-image mt-80">
              <img src="images/daycare/daycaev2card03.png" alt="" width="100%"/>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-7">
            <div class="success-story-cont-top  margin-bottom4">
              <h4>Testimonials</h4>
              <p>Powered by ChatGPT's advanced AI technology Kwikbot transforms your website into a dynamic and
        ...
        <OwlCarousel className="owl-theme" ref={carouselRef} {...options}>
                    ...
                    <div class="card-testimonial">
                      <div class="col-lg-11">
                        <h2 class="card-testomonial-heading">
                          Our center has seen a 40% reduction in administrative time since we implemented the AI chatbot.
                        </h2>

                        <div class="col-lg-12">
                          <p class="card-tstimonial-text"> Jane Smith, Sunshine Daycare Center</p>
                        </div>
                      </div>
                  ...
                  <div class="col-lg-12">
                    <div class="card-testimonial">
                      <div class="col-lg-11">
                        <h2 class="card-testomonial-heading">
                          The chatbot has been a game-changer in our communication with parents. They love the immediate response!
                        </h2>
